...
def VisualizeKeypoints(img, axs, camera_pose, keypoints):
    """
    ...
    axs[0].plot(keypoints_filter[:, 0], keypoints_filter[:, 1], 'o', color='green', markerfacecolor='none', linewidth=2, label = 'keypoints') 
