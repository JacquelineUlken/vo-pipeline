...
class Config:
    ...
    init_max_corners: int = 500  # Typical between 100 and 1000
    ...
    desired_keypoints: int = 500  # Typical between 100 and 1000
    ...
    threshold_triangulation_angle: float = 2/36 * 3.14  # Typical between 1/36 pi and 5/36 pi
    # ransac
